...
//      We can use hook for add new location field from other plugin add-on
            return apply_filters('en_trinet_add_location', $en_location_data);
        }
        ...
        static public function en_arrange_location_table_row($en_location_list, $en_data, $location_bol, $disabled_plan = '')
        {
            ...
            foreach ($en_location_list as $key => $location) {
                ...
                echo '<a href="javascript(0)" onclick="return en_trinet_location_edit(event, this,' . $location_bol . ')"> <img src = "' . EN_TRINET_DIR_FILE . '/admin/tab/location/assets/images/edit.png" title = "Edit" ></a>';
                echo '<a href="javascript(0)" onclick="return en_trinet_location_delete(event, this,' . $location_bol . ' , ' . $en_location_id . ')"> <img  src = "' . EN_TRINET_DIR_FILE . '/admin/tab/location/assets/images/delete.png" title = "Delete" ></a>';
                echo '</td>';
        ...
        static public function en_load()
        {
            ...
            echo '<input type="submit" value="Save" class="en_trinet_location_btn button-primary">';
            echo '</form>';
            echo '</div>';
            echo '</div>';

            echo \EnTrinetWarehouseTemplate\EnTrinetWarehouseTemplate::en_load();
            echo \EnTrinetDropshipTemplate\EnTrinetDropshipTemplate::en_load();
        }
