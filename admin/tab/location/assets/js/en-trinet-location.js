jQuery(document).ready(function () {
    ...
    jQuery('#en_trinet_location_zip').on('change', function (e) {
        let en_post_data = {
            'action': 'en_trinet_get_location',
            'en_trinet_location_zip': jQuery('#en_trinet_location_zip').val()
        };

        let en_params = {
            en_ajax_loading_id: '#en_trinet_location_zip,#en_location_city,#en_location_state,#en_location_country',
        };

        en_ajax_request(en_params, en_post_data, en_trinet_get_location);
    });
    ...
    jQuery('.en_trinet_location_btn').on('click', function (e) {
        ...
        var tab = get_parameter_by_trinet('tab');

        let en_post_data = {
            'tab': tab,
            'action': 'en_trinet_location_save_form_data',
            'en_post_data': jQuery(".en_popup_location_form input").serialize()
        };

        let en_params = {
            en_ajax_loading_msg_btn: '.en_trinet_location_btn',
        };

        en_ajax_request(en_params, en_post_data, en_trinet_location_save_form_data);
 ...
 */
if (typeof en_trinet_location_save_form_data != 'function') {
    function en_trinet_location_save_form_data(params, response) {
 ...
 */
if (typeof en_trinet_get_location != 'function') {
    function en_trinet_get_location(params, response) {
        let data = JSON.parse(response);
 ...
 */
if (typeof en_trinet_location_edit != 'function') {
    function en_trinet_location_edit(e, data, en_location_type) {
        e.preventDefault();
 ...
 * Get url detail
 */
if (typeof get_parameter_by_trinet != 'function') {
    function get_parameter_by_trinet(name) {
 ...
 */
if (typeof en_trinet_location_delete != 'function') {
    function en_trinet_location_delete(e, data, en_location_type, en_location_id) {
        ...
        jQuery('.en_location_cancel_delete').on('click', function () {
            event_id = false;
            en_popup_confirmation_location_delete_hide();
            window.location.href = jQuery('.en_location_cancel_delete').attr('href');
        });
...
if (typeof en_location_confirm_delete != 'function') {
    function en_location_confirm_delete(data, en_location_type, en_location_id) {
        ...
        let en_post_data = {
            'tab': tab,
            'action': 'en_trinet_location_delete_row',
