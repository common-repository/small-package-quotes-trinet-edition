...
namespace EnTrinetDropshipTemplate;

use EnTrinetWarehouse\EnTrinetWarehouse;

if (!class_exists('EnTrinetDropshipTemplate')) {

    class EnTrinetDropshipTemplate
    {
        ...
        {
            $en_heading = $en_data = [];
            $en_dropship_list = EnTrinetWarehouse::get_data(['location' => 'dropship']);

            extract(\EnLocation::en_location_filter_data('dropship'), null);
