...
namespace EnTrinetFreightdeskOnline;

/**
 * Class EnTrinetFreightdeskOnline
 * @package EnTrinetFreightdeskOnline
 */
if (!class_exists('EnTrinetFreightdeskOnline')) {
    ...
    class EnTrinetFreightdeskOnline
    {
        ...
        static public function en_load()
        {
            ...
            if (get_option('en_fdo_company_id_status') != 1) {
                $button_connect = '<a href="javascript:void(0)" id="fd_online_id_trinet" class="button-primary">Connect</a>';
        ...
        <p>
            ...
            To establish a connection, you must have a FreightDesk Online account. If you don’t have one, ' . $link_register . ' to register.
                ...
                if (get_option('en_fdo_company_id_status') == 1) {
                    $button_connect = '<a href="javascript:void(0)" data="disconnect" id="fd_online_id_trinet" class="button-primary">Disconnect</a>';
