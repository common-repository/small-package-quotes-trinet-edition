...
namespace EnTrinetProductDetail;

use EnTrinetWarehouse\EnTrinetWarehouse;

/**
 * Add and show simple and variable products.
 * Class EnTrinetProductDetail
 * @package EnTrinetProductDetail
 */
if (!class_exists('EnTrinetProductDetail')) {
    ...
    class EnTrinetProductDetail
    {
        ...
        /**
         * Hook for call.
         * EnTrinetProductDetail constructor.
         */
        ...
        {
            return EN_TRINET_DECLARED_TRUE;
        }
        ...
        {
            $dropship = EnTrinetWarehouse::get_data(['location' => 'dropship']);
            $en_dropship_list = [];
...
//      We can use hook for add new product field from other plugin add-on
            $en_product_fields = apply_filters('en_trinet_add_product', $en_product_fields);
        ...
        public function en_app_common_plan_status()
        {
            ...
            if (isset($plan_status['hazardous_material'])) {
                if (!in_array(0, $plan_status['hazardous_material']['plan_required'])) {
                    ...
                    $this->hazardous_plan_required = apply_filters("trinet_plans_notification_link", [2, 3]);
