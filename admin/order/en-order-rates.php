...
namespace EnTrinetOrderRates;

/**
 * Order page rates.
 * Class EnTrinetOrderRates
 * @package EnTrinetOrderRates
 */
if (!class_exists('EnTrinetOrderRates')) {

    class EnTrinetOrderRates {

        /**
         * Hook in ajax handlers.
         * EnTrinetOrderRates constructor.
         */
        public function __construct() {
            add_action('wp_ajax_nopriv_en_trinet_admin_order_quotes', array($this, 'en_trinet_admin_order_quotes'));
            add_action('wp_ajax_en_trinet_admin_order_quotes', array($this, 'en_trinet_admin_order_quotes'));
        }

        /**
         * Get quotes from calculate shipping forcefully
         */
        public function en_trinet_admin_order_quotes() {
            global $woocommerce;
            $errors = array();
            ...
            $shipping_class = new \EnTrinetShippingRates();
