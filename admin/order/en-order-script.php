...
namespace EnTrinetOrderScript;

/**
 * Script for send ajax request.
 * Class EnTrinetOrderScript
 * @package EnTrinetOrderScript
 */
if (!class_exists('EnTrinetOrderScript')) {
    ...
    class EnTrinetOrderScript
    {
         ...
         * EnTrinetOrderScript constructor.
         */
        public function __construct()
        {
            add_action('admin_print_scripts', [$this, 'en_trinet_order_script'], 50);
        }

        public function en_trinet_order_script()
        {
            global $post;
            ?>
                    ...
                    let data =
                        {
                            ...
                            'action': 'en_trinet_admin_order_quotes'
                        };
                    jQuery.ajax({
                        type: "POST",
                        url: ajaxurl,
